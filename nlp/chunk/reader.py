...
def load_data(data_path=None):
    train_path = os.path.join(data_path, "train_l.txt") #os.path.join(path1[, path2[, ...]])  #把目录和文件名合成一个路径
    dev_path = os.path.join(data_path, "dev_l.txt")
    test_path = os.path.join(data_path, "test_l.txt")
    ...
    #_save_vocab(word_to_id, '../../data/word_to_id')
    #_save_vocab(tag_to_id, '../../data/tag_to_id')
